export const projects = [
  {
    ...
    role:
      "Fullstack Developer — designed the architecture, developed the frontend experience, built backend services, integrated authentication, and implemented real-time communication.",
    ...
    github:
      "https://github.com/emm-ok/SyncSpace",

    demo:
      "https://sync-space-topaz.vercel.app",
...

  {
    ...
    role:
      "Frontend-focused fullstack developer responsible for application architecture, UI implementation, API integration, and database structure.",
    ...
    github:
      "https://github.com/emm-ok/Neominds-Builders-Guide",

    demo:
      "https://neominds-builders-guide.vercel.app/",
...

  {
    ...
    role:
      "Fullstack developer responsible for frontend architecture, CMS integration, UI development, and performance optimization.",
    ...
    github:
      "https://github.com/emm-ok/CSHub-Sanity-NextJS-Store",

    demo:
      "https://cs-hub-sanity-next-js-store-ulj4.vercel.app/",
...

  {
    ...
    role:
      "Frontend developer responsible for UI design, responsive implementation, and interaction design.",
    ...
    challenges:[
      "Creating premium visual design",
      "Responsive layouts"
    ],

    github:
      "https://github.com/emm-ok/CasualsHub_Landing_Page",

    demo:
      "https://casuals-hub-landing-page.vercel.app/",
